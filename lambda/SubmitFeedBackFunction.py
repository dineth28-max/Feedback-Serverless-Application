...
TABLE_NAME = os.environ.get('TABLE_NAME', 'Feedback-list')  # DynamoDB Table name for storing feedback
BUCKET_NAME = os.environ.get('BUCKET_NAME', 'feedback-pdfs')  # S3 bucket name for storing feedback attachments
ADMIN_EMAIL = os.environ.get('ADMIN_EMAIL', 'hera82076@gmail.com')  # Admin email to receive notifications
